...
namespace Plugins.xNodeUtilityAi.MainNodes.Editor {
    ...
    public class DataSelectorNodeEditor : NodeEditor {
        ...
        public override void OnBodyGUI() {
            ...
            if (_dataSelectorNode.ReflectionDatas.Count > 0) {
                EditorGUILayout.BeginHorizontal();
                GUILayout.Label("Search");
                _search = EditorGUILayout.TextField(_search);
                EditorGUILayout.EndHorizontal();
                string[] choices = _dataSelectorNode.ReflectionDatas.Select(info => info.Name).ToArray();
                ...
                _dataSelectorNode.SelectedReflectionData = _dataSelectorNode.ReflectionDatas.ElementAt(_choiceIndex);
                NodePort nodePort = _dataSelectorNode.GetPort(nameof(_dataSelectorNode.Output));
                nodePort.ValueType = _dataSelectorNode.SelectedReflectionData.Type;
